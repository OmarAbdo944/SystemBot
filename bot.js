...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '619585079584489492').send(` **Welcome To Server Discord Bot **  `)
});
/////////
...
/////
client.login('NjE5NTk1Mjg5MDMxOTk5NTA4.XXKiHA._NtB4m_1BF3iAsSjO6gfAhRP-iM');
